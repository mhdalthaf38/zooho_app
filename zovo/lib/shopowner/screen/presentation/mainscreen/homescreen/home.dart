...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          builder: (context) => AlertDialog(
            backgroundColor: AppColors.secondaryCream,
            title: Text('Shop is Open or Closed?',style: GoogleFonts.poppins(
                          color: AppColors.primaryOrange,
  ...
  Navigator.pop(context);
                ...
                child: Text('Closed',style: GoogleFonts.poppins(
                    ...
                    child: Column(
                      children: [
                        ...
                        child:Center(
                          child: Text('Shop is Open',style: GoogleFonts.poppins(
                        ...
                        child:Center(
                          child: Text('Shop is closed',style: GoogleFonts.poppins(
                                  color: AppColors.secondaryCream,
                                 fontSize: screenWidth * 0.035, 
                                   fontWeight: FontWeight.w900
                                )),
